...
import { fonts, codeSnippets } from "@/constants";
  ...
  return (
    ...
    >
      ...
      <header className="grid grid-cols-6 gap-3 items-center px-4 py-3">
        ...
        <div className="col-span-4 flex justify-center">
          <input
            type="text"
            value={store.title}
            onChange={(e) => Store.setState({ title: e.target.value })}
            spellCheck={false}
      ...
      >
        <Editor
          value={store.code}
          onValueChange={(code) => Store.setState({ code })}
          highlight={(code) =>
